...
export type AddStakePositionErrors = { 'TransferError': string } |
...
export interface Args { 'principal': Principal, 'state': WithdrawState }
export interface Args_1 { 'amount': bigint }
export interface Args_2 { 'starting_day': bigint, 'limit': [] | [bigint] }
...
export type Args_7 = { 'Upgrade': UpgradeArgs } |
{ 'Init': InitArgs };
...
export type ClaimRewardErrors = { 'NoTokensProvided': string } |
...
export type ClaimRewardStatus = { 'Failed': string } |
{ 'None': null } |
{ 'InProgress': null };
...
{ 'NotAuthorized': string } |
{ 'CallError': string };
export type DissolveInstantlyStatus = { 'DissolvedInstantly': null } |
{ 'Failed': string } |
{ 'None': null } |
{ 'InProgress': null };
...
export type GeneralError = { 'TransactionAddError': string } |
{ 'TransferError': string } |
{ 'AlreadyProcessing': string } |
...
export interface InitArgs {
  'allowed_reward_tokens': Array<TokenSymbol>,
...
export type ManageStakePositionArgs = { 'Withdraw': {} } |
...
export type NormalWithdrawStatus = { 'Failed': string } |
{ 'None': null } |
{ 'Withdrawn': null } |
{ 'InProgress': null };
...
export type Result_4 = { 'Ok': StakePositionResponse } |
...
export type StartDissolvingErrors = { 'DissolvementsLimitReached': string } |
{ 'AlreadyProcessing': string } |
{ 'InvalidPrincipal': string } |
{ 'NotFound': string } |
{ 'NotAuthorized': string } |
...
export type VoteType = { 'SelfVote': null } |
{ 'FolloweeVote': null };
...
export type WithdrawErrors = { 'NoValidDissolveEvents': string } |
{ 'AlreadyProcessing': string } |
...
export type WithdrawRequestErrors = { 'TransferError': string } |
...
{ 'CallError': string } |
{ 'InvalidState': string };
export type WithdrawState = { 'None': null } |
...
export interface _SERVICE {
  ...
  'add_whitelisted_principal': ActorMethod<[Array<Principal>], Result_1>,
  'allocated_rewards_balance': ActorMethod<
    [null],
    Array<[TokenSymbol, Result_2]>
  >,
  'commit': ActorMethod<[], undefined>,
  'create_neuron': ActorMethod<[Args_1], Result_3>,
  'get_all_stake_positions': ActorMethod<
    [],
    Array<[Principal, StakePosition]>
  >,
  ...
  'manage_stake_position': ActorMethod<[ManageStakePositionArgs], Result_4>,
  'manual_sync_neurons': ActorMethod<[null], Result>,
  'processing_rewards_balance': ActorMethod<
    [null],
    Array<[TokenSymbol, Result_2]>
  >,
  'set_dissolve_event_time': ActorMethod<[Args_6], Result>,
  'unallocated_rewards_balance': ActorMethod<
    [null],
    Array<[TokenSymbol, Result_5]>
  >,
}
