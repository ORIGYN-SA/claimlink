...
export const mockCollections: Collection[] = [
  {
    ...
    description:
      "A curated collection of digital artworks featuring various styles and mediums",
    imageUrl:
  ...
  },
  {
    ...
    description:
      "Professional photography collection showcasing urban landscapes and street art",
    imageUrl:
      "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop",
    itemCount: 15,
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Algorithmically generated abstract art pieces with unique patterns",
    imageUrl:
      "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop",
    itemCount: 8,
    status: "Draft",
  ...
  },
  {
    ...
    description:
      "Captured moments from various music festivals around the world",
    imageUrl:
      "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop",
    itemCount: 32,
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Rare vintage cars from the 1960s and 1970s, digitally restored",
    imageUrl:
      "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop",
    itemCount: 12,
    status: "Inactive",
  ...
  },
  {
    ...
    description:
      "Stunning nature photography from national parks and wilderness areas",
    imageUrl:
      "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop",
    itemCount: 45,
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Modern architectural designs and cityscapes from around the globe",
    imageUrl:
      "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop",
    itemCount: 28,
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Imaginative fantasy artwork featuring mythical creatures and magical landscapes",
    imageUrl:
      "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop",
    itemCount: 20,
    status: "Draft",
...
export const getCollectionsByStatus = (
