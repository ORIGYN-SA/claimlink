    ...
    if (storedData) {
      try {
        ...
        if (parsed.transaction) {
          parsed.transaction.amount = parsed.transaction.amount ? BigInt(parsed.transaction.amount) : undefined;
          parsed.transaction.fee = parsed.transaction.fee ? BigInt(parsed.transaction.fee) : undefined;
        }
