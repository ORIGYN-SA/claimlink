        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-white">
              <span className="italic font-extralight text-2xl block">Reset</span>
              <span className="font-normal text-3xl">password</span>
            </h1>
            <p className="text-[#e1e1e1] text-sm font-medium mt-4">
          ...
          {/* Demo Link to New Password Page */}
          <div className="text-center mt-4">
            <Link 
              to="/new-password" 
              className="text-white/70 hover:text-white text-sm transition-colors"
            >
              Demo: Go to new password page
            </Link>
          </div>
