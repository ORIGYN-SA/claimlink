...
export const getCertificatesByCollection = (collectionName: string): Certificate[] => {
  return mockCertificates.filter(certificate => certificate.collectionName === collectionName);
};

export const getCertificatesByStatus = (status: Certificate['status']): Certificate[] => {
  return mockCertificates.filter(certificate => certificate.status === status);
};
...
export const getCertificatesForCollection = (collectionId: string, mockCollections: any[]): Certificate[] => {
