...
import test from "../assets/img/test3.png";
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row h-[90vh]">
        ...
        <div className="w-full lg:w-1/2 h-52 lg:h-auto mt-6 lg:mt-0">
          <img className="w-full h-full object-cover" src={test} alt="" />
        </div>
      </div>
      ...
      <div className="bg-gray-100 p-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6 mx-6 lg:mx-20">
          <div className="bg-white py-6 px-12 rounded-2xl flex flex-col items-center">
            <img className="h-48 w-48 lg:h-96 lg:w-96" src={test} alt="" />
            <h2 className="text-2xl font-semibold p-6">Linkdrop Dashboard</h2>
      ...
      <div className="bg-gray-100 p-6 w-full">
        ...
        <div className="flex flex-col lg:flex-row items-center h-full mx-6 lg:mx-20 bg-white py-6">
